...
export function setOpenDropdown(dd) { openDropdown = dd; }
...
export function buildDropdown(id, val, includeAuto, onChange, disabled, panelRef) {
...
export function buildEngineDropdown(id, val, onChange, panelRef) {
  const dd = document.createElement("div");
  dd.className = "tr-dd";
...
export function positionPanel(panel, tBar) {
...
export function attachCopyHandler(btn, text) {
